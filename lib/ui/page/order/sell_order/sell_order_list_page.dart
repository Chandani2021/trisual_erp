...
class SellOrderListPage extends StatelessWidget {
  static const String routeName = '/saleorder_list';

  const SellOrderListPage({Key? key}) : super(key: key);
  @override
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return const SellOrderListTile();
                          }),
                    ),
                  ),
                )
