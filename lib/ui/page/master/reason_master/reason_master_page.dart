...
import 'package:trishul_erp/dialog/master/dialog_add_reason.dart';
...
class ReasonMasterPage extends StatelessWidget {
  static const String routeName = '/reason_master';

  const ReasonMasterPage({Key? key}) : super(key: key);
  @override
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return const DialogAddReason();
                    },
                  );
                },
                icon: const Icon(Icons.add),
                label: Text(AppStrings.strAddReason),
              ),
            ),
          ],
        ),
