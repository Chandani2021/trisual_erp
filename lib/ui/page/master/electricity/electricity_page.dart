...
import 'package:trishul_erp/ui/page/master/electricity/electricity_list_tile.dart';

import 'package:trishul_erp/widgets/widget_appbar_with_back_button.dart';

class ElectricityPage extends StatelessWidget {
  static const String routeName = '/electricity';
          ...
          children: [
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return const ElectricityListTile();
                          }),
                    ),
                  ),
                )
            ...
            Positioned(
              ...
              child: FloatingActionButton.extended(
                ...
                label: Text(AppStrings.strAddElectricity),
              ),
            ),
          ],
        ),
