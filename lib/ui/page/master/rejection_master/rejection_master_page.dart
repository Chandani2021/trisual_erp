...
import 'package:trishul_erp/dialog/master/dialog_add_rejection_master.dart';
...
class RejectionMasterPage extends StatelessWidget {
  static const String routeName = '/rejection_master';

  const RejectionMasterPage({Key? key}) : super(key: key);
  @override
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return const DialogAddRejectionMaster();
                    },
                  );
                },
                icon: const Icon(Icons.add),
                label: Text(AppStrings.strAddRejectionMaster),
              ),
            ),
          ],
        ),
