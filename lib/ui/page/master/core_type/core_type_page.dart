...
import 'package:trishul_erp/dialog/master/dialog_add_core_type.dart';
...
class CoreTypePage extends StatelessWidget {
  static const String routeName = '/core_type';

  const CoreTypePage({Key? key}) : super(key: key);
  @override
          ...
          children: [
            ...
            Positioned(
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return const DialogAddCoreType(
                        title: '+91',
                      );
                    },
                  );
                ...
                label: Text(AppStrings.strAddCoreType),
              ),
            ),
          ],
        ),
