...
import 'package:trishul_erp/dialog/hr/dialog_add_department.dart';
import 'package:trishul_erp/model/department_list_model.dart';
import 'package:trishul_erp/ui/page/hr/department/department_list_tile.dart';
...
class DepartmentListPage extends StatefulWidget {
  static const String routeName = '/department_list';
...
class _DepartmentListPageState extends State<DepartmentListPage> {
  ...
  Future departmentList(BuildContext context) async {
    setState(() {
      _isLoading = true;
    });
    return await API.departmentList(context).then((response) {
      setState(() {
        _isLoading = false;
      });
      if (response!.code == '200') {
        setState(() {
          data = response.data!.allDepartment!;
          ...
          children: [
            ...
            Positioned(
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return const DialogAddDepartment(
                        title: '+91',
                      );
                    },
                  );
                ...
                label: Text(AppStrings.strAddDepartment),
              ),
            ),
          ],
        ),
