...
class DialogAddFurnace extends StatefulWidget {
  final String? title;
  const DialogAddFurnace({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogAddFurnaceState createState() => _DialogAddFurnaceState();
}

class _DialogAddFurnaceState extends State<DialogAddFurnace> {
  double padding = 20;
