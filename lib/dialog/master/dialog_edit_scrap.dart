...
class DialogEditScrap extends StatefulWidget {
  final String? title;
  const DialogEditScrap({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogEditScrapState createState() => _DialogEditScrapState();
}

class _DialogEditScrapState extends State<DialogEditScrap> {
  double padding = 20;
