...
class DialogAddProductType extends StatefulWidget {
  final String? title;

  const DialogAddProductType({Key? key, @required this.title})
      : super(key: key);

  @override
  _DialogAddProductTypeState createState() => _DialogAddProductTypeState();
}

class _DialogAddProductTypeState extends State<DialogAddProductType> {
  double padding = 20;
