...
class DialogEditCoreType extends StatefulWidget {
  final String? title;
  const DialogEditCoreType({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogEditCoreTypeState createState() => _DialogEditCoreTypeState();
}

class _DialogEditCoreTypeState extends State<DialogEditCoreType> {
  double padding = 20;
