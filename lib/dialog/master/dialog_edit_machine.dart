...
class DialogEditMachine extends StatefulWidget {
  final String? title;

  const DialogEditMachine({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogEditMachineState createState() => _DialogEditMachineState();
}

class _DialogEditMachineState extends State<DialogEditMachine> {
  double padding = 20;
