...
class DialogAddReason extends StatefulWidget {
  const DialogAddReason({
    Key? key,
  }) : super(key: key);

  @override
  _DialogAddReasonState createState() => _DialogAddReasonState();
}

class _DialogAddReasonState extends State<DialogAddReason> {
  double padding = 20;
