...
class DialogAddLaddle extends StatefulWidget {
  final String? title;
  const DialogAddLaddle({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogAddLaddleState createState() => _DialogAddLaddleState();
}

class _DialogAddLaddleState extends State<DialogAddLaddle> {
  double padding = 20;
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: AppStyles.textFieldInputDecoration
                            .copyWith(hintText: AppStrings.strHintEnterLaddle),
