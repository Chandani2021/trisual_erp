...
class DialogAddRejectionType extends StatefulWidget {
  const DialogAddRejectionType({
    Key? key,
  }) : super(key: key);

  @override
  _DialogAddRejectionTypeState createState() => _DialogAddRejectionTypeState();
}

class _DialogAddRejectionTypeState extends State<DialogAddRejectionType> {
  double padding = 20;
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        style: AppStyles.textInputTextStyle,
                        decoration: AppStyles.textFieldInputDecoration.copyWith(
                            hintText: AppStrings.strHintEnterShortName),
                        onSaved: (String? value) {},
                      ),
                      const SizedBox(
                        height: 10,
