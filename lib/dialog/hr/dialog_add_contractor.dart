...
class DialogAddContractor extends StatefulWidget {
  final String? title;
  const DialogAddContractor({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogAddContractorState createState() => _DialogAddContractorState();
}

class _DialogAddContractorState extends State<DialogAddContractor> {
  double padding = 20;
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: AppStyles.textFieldInputDecoration.copyWith(
                            hintText: AppStrings.strHintEnterContractor),
