...
class DialogAddDepartment extends StatefulWidget {
  final String? title;
  const DialogAddDepartment({Key? key, @required this.title}) : super(key: key);

  @override
  _DialogAddDepartmentState createState() => _DialogAddDepartmentState();
}

class _DialogAddDepartmentState extends State<DialogAddDepartment> {
  double padding = 20;
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: AppStyles.textFieldInputDecoration.copyWith(
                            hintText: AppStrings.strHintEnterDepartment),
