...
class DialogAddDesignation extends StatefulWidget {
  final String? title;
  const DialogAddDesignation({Key? key, @required this.title})
      : super(key: key);

  @override
  _DialogAddDesignationState createState() => _DialogAddDesignationState();
}

class _DialogAddDesignationState extends State<DialogAddDesignation> {
  double padding = 20;
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: AppStyles.textFieldInputDecoration.copyWith(
                            hintText: AppStrings.strHintEnterDesignation),
