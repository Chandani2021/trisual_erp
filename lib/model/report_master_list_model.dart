class ReportMasterListData {
  Data? data;
  String? code;
  String? message;

  ReportMasterListData({this.data, this.code, this.message});

  ReportMasterListData.fromJson(Map<String, dynamic> json) {
...
class Data {
  List<AllReportMasterItem>? allParameters;

  Data({this.allParameters});

  Data.fromJson(Map<String, dynamic> json) {
    if (json['allParameters'] != null) {
      allParameters = <AllReportMasterItem>[];
      json['allParameters'].forEach((v) {
        allParameters!.add(AllReportMasterItem.fromJson(v));
      });
    }
  }
...
class AllReportMasterItem {
  ...
  AllReportMasterItem.fromJson(Map<String, dynamic> json) {
